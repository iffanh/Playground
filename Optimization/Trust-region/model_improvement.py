...
if __name__ == '__main__':
    ...
    lp = LagrangePolynomials(dataset, results, pdegree = 2)
    mi = ModelImprovement()
    lp2 = mi.improve_model(lpolynomials=lp, func=myfunc, L=5.0)
    ...
    plt.figure()
    plt.scatter(dataset[0, :], dataset[1, :], color='green',  marker='x')
